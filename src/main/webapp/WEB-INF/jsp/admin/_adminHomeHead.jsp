...
<div class="container">
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav">
					<li><a href="${pageContext.request.contextPath}/admin/showThesisPaper"><i class="glyphicon glyphicon-eye-open"></i>&nbsp;查看已上传论文</a></li>
				</ul>
				...
				<!-- 显示当前用户 -->
				<ul class="nav navbar-nav navbar-right">
					<p class="navbar-text">当前用户&nbsp;${sessionScope.currentUser.userNo }</p>
				</ul>
