					...
					<tbody>
						<c:forEach items="${studentList }" var="student" varStatus="loop">
							...
							<tr>
								...
								<td>${student.openscore }</td>
								<td>
									<a class="btn btn-success btn-xs" href="${passUrl }&openscore=A"><i class="fa fa-check"></i>A</a>
									<a class="btn btn-info btn-xs" href="${passUrl }&openscore=B"><i class="fa fa-check"></i>B</a>
									<a class="btn btn-warning btn-xs" href="${passUrl }&openscore=C"><i class="fa fa-check"></i>C</a>
									<a class="btn btn-danger btn-xs" href="${passUrl }&openscore=D"><i class="fa fa-check"></i>D</a>
								</td>
								<%-- <td>
									<a href="${passUrl }">完成</a> &nbsp;&nbsp;&nbsp;
